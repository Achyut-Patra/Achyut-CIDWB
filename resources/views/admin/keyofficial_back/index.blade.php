...
<td>{{ $row->order }}</td>
                            ...
                            <td>
                                {!! link_to_route(config('quickadmin.route').'.keyofficial.edit', trans('quickadmin::templates.templates-view_index-edit'), array($row->id), array('class' => 'btn btn-xs btn-info')) !!}
