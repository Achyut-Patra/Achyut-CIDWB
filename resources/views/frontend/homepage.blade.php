...
<div class="row tops">
  ...
  <div class="row tops">
    ...
    <div class="col-sm-6 citizen">
      ...
      <div class="criminals">
        <h4 class="bgflag">Criminal Investigation Department, West Bengal</h4>        
